...
/**
 * Helper for config client that wants to lookup the config server via org.springframework.cloud.zookeeper.discovery.
 *
 * @author Spencer Gibb
 */
...
public class ZookeeperDiscoveryClientConfigServiceBootstrapConfiguration {
	...
	public ZookeeperDiscoveryProperties zookeeperDiscoveryProperties(InetUtils inetUtils) {
		...
		// for bootstrap, registration is not needed, just org.springframework.cloud.zookeeper.discovery client
